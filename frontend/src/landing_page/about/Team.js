        ...
        <div className="container">
            ...
            <div className="row p-3 text-muted" style={{lineHeight:"1.8", fontSize: "1.2em"}}>
                <div className="col-6 p-3 text-center">
                    <img src="media/images/photo.jpeg" alt="" style={{borderRadius: "100%", width:"50%"}}/>
                    <h4 className="mt-2">Shubham Kr Pandey</h4>
                    <h6>Student of <b>GCET</b></h6>
                </div>
                <div className="col-6 p-3">
                    <p>Shubham Kumar Pandey is a Final year student at <b>GALGOTIAS COLLEGE OF ENGINEERING AND TECHNOLOGY</b></p>
